...
public class FontParser {
    ...
    private String xmlFontName, pngFontName;
    private BitMapFont bitMapFont;
    private String fontName;

    public FontParser(String fontName, String xmlFontName, String pngFontName) {

        this.fontName = fontName;
        this.xmlFontName = xmlFontName;
        this.pngFontName = pngFontName;

        bitMapFont = new BitMapFont(fontName);
        bitMapFont.setFontImage(pngFontName);

        System.out.print("Parsing font file: "+xmlFontName+" ...");
